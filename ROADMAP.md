...
- [ ] 2. Brand autocomplete — live filtered suggestions while typing in closet brand field
- [ ] 3. Visual outfit cards in chat — outfit recommendations render closet item photos as a collage card, not text
