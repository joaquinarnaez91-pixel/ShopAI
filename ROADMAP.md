...
- [x] 11. Multi-garment detection and split on closet upload — Claude detects items in a photo, Gemini extracts each one separately, frontend shows a review list before saving
- [ ] 12. Avatar / VTON — Gemini dresses a matched model, face-swap API (InsightFace-based, ~$0.01–0.05/image) stamps your face on as a post-process
